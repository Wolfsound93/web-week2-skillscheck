...
// Inside of checkGroceryCount, you're going to check the total number of groceries
// in your groceries array using .length. Using an if/else statement,
// check if the number of groceries is greater than or equal to 5. If it is,
...
function checkGroceryCount() {
  if (groceries >= 5) {
    ...
    return '1 item';
  } else if (groceries <= 5 && groceries >= 5) {
