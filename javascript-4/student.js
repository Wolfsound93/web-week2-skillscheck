...
// CODE HERE
let faveColors = ['black', 'purple', 'red'];
//////////////////Step 2////////////////////
...
let me = {
  ...
  superPowers: [
    ...
    'Calamitous Crop Duster'
  ],
  superPowerXP: Math.floor(Math.random() * 100) + 1,
  profileImage: window.URL(
...
// hat is what this function will do. In your function, loop over the obj parameter passed in,
