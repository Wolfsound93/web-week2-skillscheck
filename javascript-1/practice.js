...
// Create a function called 'iLove' that takes in two string parameters,
// 'name' and 'love'. Have the function take the two parameters and return a string that says
...
// Code Here
let forTheLoveOfGeorge = notGeorge.map(function(val) {
